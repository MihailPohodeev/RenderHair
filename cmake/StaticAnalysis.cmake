function(__RenderHair_target_enable_static_analysis TARGET_NAME)

    if (NOT RENDERHAIR_ENABLE_STATIC_ANALYSIS)
        return()
    endif()
    
    __RenderHair_target_enable_cppcheck(${TARGET_NAME})
    __RenderHair_target_enable_clang_tidy(${TARGET_NAME})

endfunction()


function(__RenderHair_target_enable_cppcheck TARGET_NAME)
...
function(__RenderHair_target_enable_clang_tidy TARGET_NAME)
